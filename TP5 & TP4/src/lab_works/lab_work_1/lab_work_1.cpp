...
namespace M3D_ISICG
{
	...
	bool LabWork1::init()
	{     	
        vertices = { Vec3f( 0.0f, 0.5f, 0.0f ), Vec3f( 0.5f, -0.0f, 0.0f ),  Vec3f( 0.75f, 0.75f, 0.0f ),
					 Vec3f( 0.5f, 0.0f, 0.0f ), Vec3f( 0.0f, -0.5f, 0.0f ),  Vec3f( 0.75f, -0.75f, 0.0f ),
					 Vec3f( -0.5, 0.0f, 0.0f ), Vec3f( 0.0f, -0.5f, 0.0f ), Vec3f( -0.75f, -0.75f, 0.0f ) ,
			          Vec3f( -0.5, 0.0f, 0.0f ), Vec3f( 0.0f, 0.5f, 0.0f ), Vec3f( -0.75f, 0.75f, 0.0f )
