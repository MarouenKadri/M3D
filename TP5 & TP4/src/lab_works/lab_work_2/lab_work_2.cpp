...
//_____________vao & vbo_color____________________________________________________________________
		...
		BrightnessUniformLocation	= glGetUniformLocation( shaderProgram, " BrightnessU" );
		//glUniform1f( BrightnessUniformLocation, Brightness );   
		std::cout << "hey From labwork 2"<<std::endl;
	...
	{ 
		  const float t = glm::sin( _time )*0.5; 
