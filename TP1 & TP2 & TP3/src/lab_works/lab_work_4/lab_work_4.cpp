...
namespace M3D_ISICG
{
	...
	bool LabWork4::init()
	{
		...
		//_bunny.load( "Standford Bunny One", "data/models/bunny.obj" );

		_bunny.load( "Salle de conférence", "data/models/conference.obj" );
		//_bunny._transformation = glm::scale( _bunny._transformation, Vec3f( 0.03f ) );
	...
	void LabWork4::_initCamera()
	{
		...
		_camera.setPosition( Vec3f( 0.f, 0.f, 3.0f ) );
	}
} // namespace M3D_ISICG
