...
namespace M3D_ISICG
{
	...
	bool LabWork5::init()
	{
		...
		//_bunny.load( "bunnybg", "C:/Users/alstm/source/repos/M3D_ISICG_2021v1311v1/data/models/conference.obj" );
		_bunny._transformation = glm::scale( _bunny._transformation, Vec3f( 0.05f ) );
